...
const GLOBAL_LOG_PATH = "C:\\SierraChart\\ACS_Source\\BTCacsil\\btc_ingest\\logs\\nexus-workflow.log";
  ...
  targets: [
    {
      ...
      options: {
        ...
        messageFormat: "\x1b[32m[{module}]\x1b[0m {msg}", // Green for Workflow
...
rootLogger.info({ targets: fileTargets }, "🚀 Super-Pino V2.0 initialized for Workflow-MCP");
