...
console.log(
  '%c🧠 OverMind-MCP',
  'font-size: 30px; font-weight: bold; background: linear-gradient(135deg, #ff006e, #b537f2, #00fff5); -webkit-background-clip: text; -webkit-text-fill-color: transparent;',
);
console.log('%cThe future of AI orchestration', 'font-size: 16px; color: #00fff5;');
console.log(
  '%cJoin us on Discord: https://discord.gg/4AR82phtBz',
  'font-size: 12px; color: #b537f2;',
);
