import { O as OAuthProxy, a as OAuthProviderConfig, b as OAuthTransaction, C as ConsentData, T as TokenStorage, c as TokenVerifier, d as TokenVerificationResult, P as PKCEPair } from '../OAuthProxy-ChT_jBnZ.cjs';
export { A as AuthorizationParams, j as ClientCode, k as DCRClientMetadata, l as DCRRequest, m as DCRResponse, D as DEFAULT_ACCESS_TOKEN_TTL, f as DEFAULT_ACCESS_TOKEN_TTL_NO_REFRESH, g as DEFAULT_AUTHORIZATION_CODE_TTL, h as DEFAULT_REFRESH_TOKEN_TTL, i as DEFAULT_TRANSACTION_TTL, n as OAuthError, o as OAuthProxyConfig, e as OAuthProxyError, p as ProxyDCRClient, R as RefreshRequest, q as TokenMapping, r as TokenRequest, s as TokenResponse, U as UpstreamTokenSet } from '../OAuthProxy-ChT_jBnZ.cjs';
